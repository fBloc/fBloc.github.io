  ...
  return (
    <main className='bg-gray-900 rounded-t-2xl text-white py-40'>
        ...
        <div className='mb-60 text-center'>
          ...
          <div className='max-w-7xl mx-auto flex mt-20 mb-60'>
            ...
            <div className='flex-1'>
              ...
              <div className='mt-6 bg-blue-400 text whiteray-400 rounded-lg h-10 w-3/5 mx-auto leading-10'>
                50 7 * * *
              </div>
              <p className='mt-2'>
                手动触发
      ...
      <div className='text-center '>
        <a href="#" className='inline-flex items-center justify-between text-white cursor-pointer mr-8 h-12 px-4 text-xl bg-blue-400 border border-solid border-transparent rounded-lg hover:no-underline hover:text-white'>
          查看示例项目
        </a>

        <a href={siteConfig.url} target="_blank" className='inline-flex items-center justify-between h-12 px-4 text-blue-400 cursor-pointer text-xl bg-transparent border border-solid border-blue-400 rounded-lg hover:no-underline hover:text-blue-400'>
          前往GitHub
        </a>
